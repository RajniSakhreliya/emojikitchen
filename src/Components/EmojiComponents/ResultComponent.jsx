...
const ResultComponent = ({ finalEmoji, width = 70 }) => {
  ...
  return (
    <div
      className="resultComponent m-2 hover:bg-[#F1F3F4]"
      onClick={() => {
    ...
    >
      <div className={`relative transition duration-100`} style={styles.view}>
        {imageLoading && !imageError && <div className="loading-circle"></div>}
        ...
        {imageError && (
          <img loading="lazy" className="p-3" src={icError} alt="Emoji" />
        )}
      </div>
